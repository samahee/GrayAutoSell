...
## Installation 
[Download the latest version](https://github.com/samahee/GrayAutoSell/releases/latest) and drop it the `Interfaces/AddOns/GrayAutoSell` folder. That's it!
...
## Found a bug?
Please use the [Issue tracker](https://github.com/samahee/GrayAutoSell/issues) and I'll have a look. Feature requests are welcome. 
